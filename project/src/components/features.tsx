        ...
        <>
            <div className="w-full p-10 justify-center">
                ...
                <div className="relative grid grid-cols-1 m-10 gap-y-10 md:grid-cols-2 lg:grid-cols-3">
                    <div className={`${poppins.className} h-60 w-[90%] bg-white rounded-2xl text-gray-500 shadow-2xl flex justify-center text-lg p-5`}>
                        <div className="block">
                    ...
                    <div className={`${poppins.className} h-60 w-[90%] bg-white rounded-2xl text-gray-500 shadow-2xl flex justify-cente text-lg p-5`}>
                        <div className="block">
